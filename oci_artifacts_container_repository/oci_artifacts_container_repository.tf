...
# resource "oci_artifacts_container_repository" "k8s-dashboard-backend_platform_linux-x86_64" {
#   # Required
#   compartment_id = var.compartment_id
#   display_name   = "k8s-dashboard-backend_platform_linux-x86_64"
...
resource "oci_artifacts_container_repository" "k8s-dashboard-backend_platform_linux-arm64" {
  # Required
  compartment_id = var.compartment_id
  display_name   = "k8s-dashboard-backend_platform_linux-arm64"
...
# resource "oci_artifacts_container_repository" "k8s-dashboard-frontend_platform_linux-x86_64" {
#   # Required
#   compartment_id = var.compartment_id
#   display_name   = "k8s-dashboard-frontend_platform_linux-x86_64"
...
resource "oci_artifacts_container_repository" "k8s-dashboard-frontend_platform_linux-arm64" {
  # Required
  compartment_id = var.compartment_id
  display_name   = "k8s-dashboard-frontend_platform_linux-arm64"
